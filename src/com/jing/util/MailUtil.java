...
public class MailUtil {
	...
	public static void main(String[] args) {
			MailUtil m=new MailUtil("SMTP.qq.com","2379817864@qq.com","111111qqq");
			m.setDisplayName("沙琪玛啊");
			m.addBCC("17778045265@163.com");
			try {
				m.addAttachfile("E://abc.jpg");
				m.addAttachfile("e://爸爸身份证.txt");
				
				m.sendMail("你好", "08151720你好呵呵。", "17778045265@163.com");
